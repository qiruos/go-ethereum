...
import (
	...
	"github.com/qiruos/go-ethereum/crypto/signify"
	"github.com/qiruos/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/qiruos/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/qiruos/go-ethereum/internal/version.gitDate="+env.Date)
	}
